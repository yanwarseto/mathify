        ...
        <div class="main_menu">
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="container">
                    ...
                    <a class="navbar-brand logo_h" href="<?= base_url('welcome') ?>"><img src="<?= base_url('assets/') ?>img/elearnn.png" style="height:50px;" alt=""></a>
                    ...
                    <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                        <ul class="nav navbar-nav menu_nav ml-auto">
                            ...
                            <li class="nav-item" id="navtentang"><a class="nav-link" href="<?= base_url('welcome/tentang') ?>">Materi</a>
                            </li>
                            <li class="nav-item " id="navpelajaran">
                                <a href="<?= base_url('welcome/pelajaran') ?>" class="nav-link" role="button" aria-haspopup="true" aria-expanded="false">Latihan</a>
                            </li>
                            <li class="nav-item" id="navkontak"><a class="nav-link" href="<?= base_url('welcome/kontak') ?>">Evaluasi</a>
                            </li>
                        </ul>
                    </div>
                </div>
