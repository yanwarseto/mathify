        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-2  col-md-6 col-sm-6">
                <div class="single-footer-widget tp_widgets">
                    ...
                    <ul class="list">
                        ...
                        <li><a href="javaScript:void(0);">Masalah Yang Berhubungan dengan Segitiga dan Segiempat</a></li>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                ...
                <p style="text-align: justify;">
                    ...
                    video, materi dan sistem ujian yang tersedia secara gratis. Learnify dibuat ditujukan agar para
